...
class TestSmokeTest():
  ...
  def test_test4JoinPageDataEntry(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Cristian")
    self.driver.find_element(By.NAME, "lname").send_keys("Ullua")
    self.driver.find_element(By.NAME, "bizname").send_keys("Test co.")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Test position")
  ...
  def test_test5AdminPageUsernamePassword(self):
    ...
    self.driver.find_element(By.ID, "password").send_keys("testinvalidpass")
